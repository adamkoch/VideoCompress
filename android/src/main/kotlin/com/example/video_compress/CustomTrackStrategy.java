 ...
 */
public class CustomTrackStrategy implements TrackStrategy {
    private final static String TAG = CustomTrackStrategy.class.getSimpleName();
    ...
    public interface BitRateCallback {
        int calculateBitrate(int width, int height, int frameRate);
    }
    ...
    public static class Options {
        ...
        private BitRateCallback bitRateCallback;
    }
    ...
    public static class Builder {
        ...
        public Builder bitRateCallback(BitRateCallback callback) {
        ...
        public Options options() {
            ...
            options.bitRateCallback = bitRateCallback;
            return options;
        }

        @NonNull
        public CustomTrackStrategy build() {
            return new CustomTrackStrategy(options());
        }
    }
    ...
    @SuppressWarnings("WeakerAccess")
    public CustomTrackStrategy(@NonNull Options options) {
    ...
    public TrackStatus createOutputFormat(@NonNull List<MediaFormat> inputFormats,
        ...
        int outBitRate;
        if (options.bitRateCallback != null) {
            outBitRate = options.bitRateCallback.calculateBitrate(outWidth, outHeight, outFrameRate);
        } else if (options.targetBitRate == BITRATE_UNKNOWN) {
            outBitRate = (int) BitRates.estimateVideoBitRate(outWidth, outHeight, outFrameRate);
        } else {
            outBitRate = (int) options.targetBitRate;
        }
